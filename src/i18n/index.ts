	...
	section: {
		...
		commitActivity: {
			...
			subtitle: tr(
				...
				'My daily contributions across GitHub and GitLab — combined from all repositories.',
			),
			totalCommits:  tr('Total Commit',    'Total Commits'),
			github:        tr('GitHub',          'GitHub'),
			gitlab:        tr('GitLab',          'GitLab'),
			combined:      tr('Gabungan',        'Combined'),
			unavailable:   tr('Data tidak tersedia saat ini.', 'Data is currently unavailable.'),
			stale:         tr('Data mungkin sudah usang.',     'Data may be outdated.'),
			updatedAt:     tr('Diperbarui',      'Updated'),
			lessText:      tr('Lebih sedikit',   'Less'),
			moreText:      tr('Lebih banyak',    'More'),
			commits:       tr('commit',          'commits'),
		},
	},
	exp: {
